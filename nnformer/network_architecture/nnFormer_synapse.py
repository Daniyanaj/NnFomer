    ...
    def forward(self, x):
        ...
        if L==32768:
            ...
            for i in range(16):
                ...
                a=a.view(B,H,W,1,C)
                y.append(a)
            x=torch.cat((y[0],y[1],y[2],y[3],y[4],y[5],y[6],y[7],y[8],y[9],y[10],y[11],y[12],y[13],y[14],y[15]),3)    
            ...
            for i in range(8):
                ...
                a=a.view(B,H,W,1,C)
                y.append(a)
            x=torch.cat((y[0],y[1],y[2],y[3],y[4],y[5],y[6],y[7]),3)    
