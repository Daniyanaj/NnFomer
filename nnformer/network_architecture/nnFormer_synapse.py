...
class Encoder2(nn.Module):
    ...
    def __init__(self,
     ...
     # stochastic depth decay rule
        ...
        act_layer=nn.GELU
        drop=0
        self.mlp=DWMlp(in_features, hidden_features=in_features*4, act_layer=act_layer, drop=drop)
    ...
    def forward(self, x):
        ...
        for i in range(1):
            ...
            if i in self.out_indices:
                ...
                out = x_out.view(-1, 2,2, 2, self.num_features[3]).permute(0, 4, 1, 2, 3).contiguous()
