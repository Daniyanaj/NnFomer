...
from vtunet.network_architecture.ASA_tumor import MEDIUMVIT
...
class vtunetTrainerV2_vtunet_tumor_base(vtunetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        :return:
        """
        cfg = "./vtunet/configs/vt_unet_base.yaml"
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        if self.fp16:
            with autocast():
                ...
                l_gan = self.gan_loss(pred_discriminator, target_discriminator)
