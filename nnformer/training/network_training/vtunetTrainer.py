...
import vtunet
from vtunet.configuration import default_num_threads
from vtunet.evaluation.evaluator import aggregate_scores
from vtunet.inference.segmentation_export import save_segmentation_nifti_from_softmax
from vtunet.network_architecture.generic_UNet import Generic_UNet
...
from vtunet.training.loss_functions.sample_gan_criteria import SetCriterion
from vtunet.postprocessing.connected_components import determine_postprocessing
from vtunet.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params, \
    default_2D_augmentation_params, get_default_augmentation, get_patch_size
from vtunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from vtunet.training.loss_functions.dice_loss import DC_and_CE_loss
from vtunet.training.network_training.network_trainer import NetworkTrainer
from vtunet.utilities.nd_softmax import softmax_helper
from vtunet.utilities.tensor_utilities import sum_tensor

matplotlib.use("agg")


class vtunetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from vtunetTrainer and the init args change then you need to redefine self.init_args
        in your init accordingly. Otherwise checkpoints won't load properly!
        """
        super(vtunetTrainer, self).__init__(deterministic, fp16)
    ...
    def preprocess_patient(self, input_files):
        ...
        :return:
        """
        from vtunet.training.model_restore import recursive_find_python_class
        ...
        preprocessor_class = recursive_find_python_class([join(vtunet.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="vtunet.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in vtunet.preprocessing" % \
                                               preprocessor_name
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        if run_postprocessing_on_folds:
            # in the old vtunet we would stop here. Now we add a postprocessing. This postprocessing can remove everything
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(vtunetTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
